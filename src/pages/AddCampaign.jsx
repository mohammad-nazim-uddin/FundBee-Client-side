...
const AddCampaign = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // console.log(name, campaignTitle, minDonation, photo, deadline, email, description, campaignType)

        const newCampaign = { campaignTitle, photo, campaignType, minDonation, deadline, email, name, description }

        fetch('https://fund-bee-server.vercel.app/allCampaign', {
            method: "POST",
    ...
    return (
        <div className='bg-base-300'>
            <div className="p-10 ">
                <form onSubmit={handleSubmit} className="bg-base-100 shadow-xl rounded-xl card-body p-10">
                    ...
                    <button type="submit" className="btn bg-[#91cb55] hover:bg-[#75c8e5] text-xl font-bold">Add Campaign</button>
